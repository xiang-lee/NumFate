  ...
  <main class="page">
    ...
    <div class="shell">
      ...
      <form id="fortune-form" class="oracle-card" autocomplete="off">
        ...
        <p id="input-feedback" class="hint" aria-live="polite">可输入 2-12 个数字，支持逗号、空格、换行，也支持生日格式如 1994-07-16。</p>
...
function renderFeedback(parsed) {
  ...
  if (count === 0) {
    feedback.textContent = '可输入 2-12 个数字，支持逗号、空格、换行，也支持生日格式如 1994-07-16；按 Ctrl/Cmd + Enter 可快速推演。'
    return
  }
